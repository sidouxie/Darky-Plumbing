          ...
          <div className="section-textil">
            ...
            <div className="textil">
              ...
              <p>
                ...
                identifier. Il s'agit notamment de votre prénom et nom, de votre
                âge, de votre adresse postale, de votre adresse courriel de
                votre localisation ou encore de votre adresse IP ; Quels sont
                vos droits concernant ces renseignements; Qui est responsable du
                traitement des renseignements personnels collectés et traités ;
                À qui ces renseignements sont transmis ; Éventuellement, la
                politique du site en matière de fichiers témoins ("cookies").
                Cette politique de confidentialité complète les Conditions
            ...
            <div className="textil">
              ...
              <p>
                ...
                recueillis par l'entremise des modes de collecte décrits ci-bas,
                dans les sections "Formulaires et modes de collecte" et
                suivantes.
              </p>
            </div>
            ...
            <div className="textil">
              <p>
                Vos renseignements personnels sont collectés par l'entremise des
                méthodes suivantes :
              </p>
              <ul>
            ...
            <div className="textil">
              <p>
                ...
                journaux ("log files") et de fichiers témoins ("cookies"). Ces
                fichiers nous permettent de traiter des statistiques et des
                informations sur le trafic, de faciliter la navigation et
                d'améliorer le service pour votre confort.
              </p>
              <strong>
                a) Description des fichiers témoins utilisés par le site
              </strong>
              <p>
                Il s'agit principalement des informations suivantes : Cookies Le
                recours à de tels fichiers nous permet d'atteindre les objectifs
                suivants : Amélioration du service et accueil personnalisé
                Création de profils personnalisés de consommation Suivis de
                commande Études statistiques En navigant sur le site, des
                fichiers témoins de tiers peuvent être enregistrés. Il s'agit
                particulièrement des tiers suivants : Cookies De plus, le site
                intègre des boutons de réseaux sociaux vous permettant de
                partager votre activité sur le site. Des fichiers témoins de ces
                réseaux sociaux sont par conséquent susceptibles d'être stockés
                sur votre ordinateur lorsque vous utilisez ces fonctionnalités.
                Ces sites disposent de politiques de confidentialité propres et
                de conditions générales d'utilisation possiblement différentes
              ...
              <p>
                ...
                témoins en configurant votre logiciel de navigation. Dans le cas
                où vous décidez de désactiver les fichiers témoins, vous pourrez
                ensuite poursuivre votre navigation sur le site. Toutefois, tout
                dysfonctionnement du site provoqué par cette manipulation ne
                peut être considéré comme étant de notre fait.
              </p>
            </div>
            ...
            <div className="textil">
              <p>
                ...
                renseignements personnels collectés pour une durée de : 12 mois
                au maximum.
              </p>
            </div>
            ...
            <div className="textil">
              ...
              <p>
                Le responsable du traitement des renseignements personnels est
                chargé de déterminer les finalités et les moyens mis au service
              ...
              <p>
                ...
                traitement des renseignements personnels s'engage à vous aviser
                en cas de rectification ou de suppression des renseignements
                personnels, à moins que cela n'entraîne pour lui des formalités,
                coûts ou démarches disproportionnés. Dans le cas où l'intégrité,
                la confidentialité ou la sécurité de vos renseignements
                personnels est compromise, le responsable du traitement s'engage
                à vous en informer par tout moyen.
              </p>
            </div>
            ...
            <div className="textil">
              <p>
                ...
                une opposition au traitement de vos renseignements personnels ou
            ...
            <div className="textil">
              ...
              <p>
                Pour assurer la sécurité de vos informations personnelles, nous
              ...
              <p>
                ...
                d'assurer la confidentialité de vos transactions. Toutefois,
                comme aucun mécanisme n'offre une sécurité maximale, une part de
                risque est toujours présente lorsqu'on utilise Internet pour
            ...
            <div className="textil">
              ...
              <p>
                ...
                conformité avec le droit en vigueur. Par conséquent, vous êtes
                invité(e) à venir consulter régulièrement cette politique de
                confidentialité afin de vous tenir informé(e) des derniers
